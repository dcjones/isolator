...
pos_t                constants::transcript_5p_extension      = 100;
pos_t                constants::transcript_3p_extension      = 100;
pos_t                constants::transcript_tss_dist_len      = 150;
pos_t                constants::transcript_tts_dist_len      = 150;
float                constants::transcript_tss_tts_dist_w    = 0.9;
pos_t                constants::transcript_min_end_exon_len  = 150;
