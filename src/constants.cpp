...
pos_t                constants::transcript_5p_extension      = 300;
pos_t                constants::transcript_3p_extension      = 300;
pos_t                constants::transcript_tss_dist_len      = 600;
pos_t                constants::transcript_tts_dist_len      = 600;
float                constants::transcript_tss_tts_dist_w    = 0.25;
