...
unsigned int         constants::min_map_qual                 = 1;
...
pos_t                constants::seqbias_tp_end               = 100;
pos_t                constants::seqbias_fp_end               = 100;
...
unsigned int         constants::sampler_hillclimb_samples    = 100;
