...
pos_t                constants::tp_dist_len                  = 1000;
pos_t                constants::fp_dist_len                  = 1000;
pos_t                constants::tp_fp_dist_pad               = 300;
float                constants::tp_fp_dist_w                 = 0.01;
float                constants::tp_fp_dist_scale             = 10000.0;
float                constants::min_transcript_weight        = 5.0;
float                constants::tmix_prior_prec              = 0.0000001;
