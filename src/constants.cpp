...
pos_t                constants::transcript_tss_dist_len      = 0;
pos_t                constants::transcript_tts_dist_len      = 0;
float                constants::transcript_tss_tts_dist_w    = 0.9;
pos_t                constants::transcript_min_end_exon_len  = 0;
...
unsigned int         constants::sampler_burnin_samples       = 300;
