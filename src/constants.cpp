...
pos_t                constants::transcript_5p_extension      = 250;
pos_t                constants::transcript_3p_extension      = 250;
pos_t                constants::transcript_tss_dist_len      = 250;
pos_t                constants::transcript_tts_dist_len      = 250;
