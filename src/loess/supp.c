/* supp.f -- translated by f2c (version 19990503).
...
/* Subroutine */ int ehg183_(s, i__, n, inc, s_len)
char *s;
integer *i__, *n, *inc;
ftnlen s_len;
{
...
/* Subroutine */ int ehg184_(s, x, n, inc, s_len)
char *s;
doublereal *x;
integer *n, *inc;
ftnlen s_len;
...
/* Subroutine */ int losave_(iunit, iv, liv, lv, v)
integer *iunit, *iv, *liv, *lv;
doublereal *v;
{
    /* Initialized data */
...
/* Subroutine */ int ehg167_(iunit, d__, vc, nc, nv, nvmax, v, a, xi, vval)
integer *iunit, *d__, *vc, *nc, *nv, *nvmax;
doublereal *v;
integer *a;
doublereal *xi, *vval;
{
...
/* Subroutine */ int lohead_(iunit, d__, vc, nc, nv)
integer *iunit, *d__, *vc, *nc, *nv;
{
    /* Builtin functions */
    integer s_rsle(), do_lio(), e_rsle(), pow_ii();
...
/* Subroutine */ int loread_(iunit, d__, vc, nc, nv, iv, liv, lv, v)
integer *iunit, *d__, *vc, *nc, *nv, *iv, *liv, *lv;
doublereal *v;
{
    /* Initialized data */
    ...
    extern /* Subroutine */ int ehg182_(), ehg168_(), ehg169_();
...
/* Subroutine */ int ehg168_(iunit, d__, vc, nc, nv, nvmax, v, a, xi, vval)
integer *iunit, *d__, *vc, *nc, *nv, *nvmax;
doublereal *v;
integer *a;
doublereal *xi, *vval;
...
/* Subroutine */ int ehg170_(k, d__, vc, nv, nvmax, nc, ncmax, a, c__, hi, lo,
	 v, vval, xi)
integer *k, *d__, *vc, *nv, *nvmax, *nc, *ncmax, *a, *c__, *hi, *lo;
...
),xi(\002,i5,\002) /\002,i5,\002,\002,i5,\002,\002,1pe15.6,\002/\002)";
...
/* Subroutine */ int lofort_(iunit, iv, liv, lv, wv)
integer *iunit, *iv, *liv, *lv;
doublereal *wv;
{
    /* Initialized data */
