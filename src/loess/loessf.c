/* loessf.f -- translated by f2c (version 19990503).
...
/* Subroutine */ int ehg126_(d__, n, vc, x, v, nvmax)
integer *d__, *n, *vc;
doublereal *x, *v;
integer *nvmax;
{
...
/* Subroutine */ int ehg125_(p, nv, v, vhit, nvmax, d__, k, t, r__, s, f, l, 
	u)
integer *p, *nv;
doublereal *v;
integer *vhit, *nvmax, *d__, *k;
doublereal *t;
integer *r__, *s, *f, *l, *u;
{
    /* Initialized data */
...
integer ehg138_(i__, z__, a, xi, lo, hi, ncmax)
integer *i__;
doublereal *z__;
integer *a;
doublereal *xi;
...
/* Subroutine */ int ehg106_(il, ir, k, nk, p, pi, n)
integer *il, *ir, *k, *nk;
doublereal *p;
integer *pi, *n;
{
...
/* Subroutine */ int ehg127_(q, n, d__, nf, f, x, psi, y, rw, kernel, k, dist,
	 eta, b, od, w, rcond, sing, sigma, u, e, dgamma, qraux, work, tol, 
	dd, tdeg, cdeg, s)
doublereal *q;
integer *n, *d__, *nf;
doublereal *f, *x;
...
doublereal *y, *rw;
integer *kernel, *k;
doublereal *dist, *eta, *b;
integer *od;
doublereal *w, *rcond;
integer *sing;
doublereal *sigma, *u, *e, *dgamma, *qraux, *work, *tol;
integer *dd, *tdeg, *cdeg;
doublereal *s;
{
    /* Initialized data */
    ...
    extern /* Subroutine */ int ehg106_(), ehg182_(), ehg184_();
    static doublereal g[15];
    static integer i__, j;
    extern /* Subroutine */ int dqrdc_(), dsvdc_(), dqrsl_();
...
/* Subroutine */ int ehg131_(x, y, rw, trl, diagl, kernel, k, n, d__, nc, 
	ncmax, vc, nv, nvmax, nf, f, a, c__, hi, lo, pi, psi, v, vhit, vval, 
	xi, dist, eta, b, ntol, fd, w, vval2, rcond, sing, dd, tdeg, cdeg, lq,
	 lf, setlf)
doublereal *x, *y, *rw, *trl, *diagl;
integer *kernel, *k, *n, *d__, *nc, *ncmax, *vc, *nv, *nvmax, *nf;
doublereal *f;
integer *a, *c__, *hi, *lo, *pi, *psi;
doublereal *v;
integer *vhit;
doublereal *vval, *xi, *dist, *eta, *b;
integer *ntol;
doublereal *fd, *w, *vval2, *rcond;
integer *sing, *dd, *tdeg, *cdeg, *lq;
doublereal *lf;
logical *setlf;
{
    /* Initialized data */
    ...
    /* Local variables */
    extern /* Subroutine */ int ehg124_(), ehg126_(), ehg182_(), ehg139_();
    ...
    c__ -= c_offset;
    vval2_dim1 = *d__ - 0 + 1;
    vval2_offset = 0 + vval2_dim1 * 1;
    vval2 -= vval2_offset;
    vval_dim1 = *d__ - 0 + 1;
    vval_offset = 0 + vval_dim1 * 1;
    vval -= vval_offset;
    --vhit;
    v_dim1 = *nvmax;
    v_offset = 1 + v_dim1 * 1;
    ...
    lf_dim1 = *d__ - 0 + 1;
    lf_dim2 = *nvmax;
    lf_offset = 0 + lf_dim1 * (1 + lf_dim2 * 1);
    lf -= lf_offset;
    lq_dim1 = *nvmax;
    lq_offset = 1 + lq_dim1 * 1;
    lq -= lq_offset;
    --w;
    --eta;
    --b;
...
/* Subroutine */ int ehg133_(n, d__, vc, nvmax, nc, ncmax, a, c__, hi, lo, v, 
	vval, xi, m, z__, s)
integer *n, *d__, *vc, *nvmax, *nc, *ncmax, *a, *c__, *hi, *lo;
doublereal *v, *vval, *xi;
integer *m;
doublereal *z__, *s;
{
    /* Initialized data */
...
/* Subroutine */ int ehg140_(iw, i__, j)
integer *iw, *i__, *j;
{
    /* Initialized data */
...
/* Subroutine */ int ehg141_(trl, n, deg, k, d__, nsing, dk, delta1, delta2)
doublereal *trl;
integer *n, *deg, *k, *d__, *nsing, *dk;
doublereal *delta1, *delta2;
{
    /* Initialized data */
    ...
    extern /* Subroutine */ int ehg184_();
    extern doublereal ehg176_();
    static integer i__;
...
/* Subroutine */ int lowesc_(n, l, ll, trl, delta1, delta2)
integer *n;
doublereal *l, *ll, *trl, *delta1, *delta2;
{
    /* Initialized data */
...
/* Subroutine */ int ehg169_(d__, vc, nc, ncmax, nv, nvmax, v, a, xi, c__, hi,
	 lo)
integer *d__, *vc, *nc, *ncmax, *nv, *nvmax;
doublereal *v;
integer *a;
doublereal *xi;
integer *c__, *hi, *lo;
{
    ...
    /* Local variables */
    extern /* Subroutine */ int ehg125_(), ehg182_();
    static integer i__, j, k, p, mc, mv;
    extern integer ifloor_();
...
/* Subroutine */ int lowesa_(trl, n, d__, tau, nsing, delta1, delta2)
doublereal *trl;
integer *n, *d__, *tau, *nsing;
doublereal *delta1, *delta2;
{
    /* Initialized data */
...
/* Subroutine */ int ehg191_(m, z__, l, d__, n, nf, nv, ncmax, vc, a, xi, lo, 
	hi, c__, v, nvmax, vval2, lf, lq)
integer *m;
doublereal *z__, *l;
integer *d__, *n, *nf, *nv, *ncmax, *vc, *a;
doublereal *xi;
integer *lo, *hi, *c__;
doublereal *v;
integer *nvmax;
...
/* Subroutine */ int ehg196_(tau, d__, f, trl)
integer *tau, *d__;
doublereal *f, *trl;
{
    /* Initialized data */
...
/* Subroutine */ int ehg197_(deg, tau, d__, f, dk, trl)
integer *deg, *tau, *d__;
doublereal *f;
integer *dk;
doublereal *trl;
...
/* Subroutine */ int ehg192_(y, d__, n, nf, nv, nvmax, vval, lf, lq)
doublereal *y;
integer *d__, *n, *nf, *nv, *nvmax;
doublereal *vval, *lf;
integer *lq;
{
    /* Initialized data */
...
doublereal ehg128_(z__, d__, ncmax, vc, a, xi, lo, hi, c__, v, nvmax, vval)
doublereal *z__;
integer *d__, *ncmax, *vc, *a;
doublereal *xi;
integer *lo, *hi, *c__;
doublereal *v;
integer *nvmax;
doublereal *vval;
{
    ...
    /* Local variables */
    extern /* Subroutine */ int ehg182_(), ehg184_();
...
/* Subroutine */ int ehg136_(u, lm, m, n, d__, nf, f, x, psi, y, rw, kernel, 
	k, dist, eta, b, od, o, ihat, w, rcond, sing, dd, tdeg, cdeg, s)
doublereal *u;
integer *lm, *m, *n, *d__, *nf;
doublereal *f, *x;
integer *psi;
doublereal *y, *rw;
integer *kernel, *k;
...
doublereal *s;
{
    ...
    extern /* Subroutine */ int ehg127_(), ehg182_();
...
/* Subroutine */ int ehg139_(v, nvmax, nv, n, d__, nf, f, x, pi, psi, y, rw, 
	trl, kernel, k, dist, phi, eta, b, od, w, diagl, vval2, ncmax, vc, a, 
	xi, lo, hi, c__, vhit, rcond, sing, dd, tdeg, cdeg, lq, lf, setlf, s)
doublereal *v;
integer *nvmax, *nv, *n, *d__, *nf;
doublereal *f, *x;
integer *pi, *psi;
doublereal *y, *rw, *trl;
integer *kernel, *k;
...
doublereal *eta, *b;
integer *od;
doublereal *w, *diagl, *vval2;
integer *ncmax, *vc, *a;
doublereal *xi;
integer *lo, *hi, *c__, *vhit;
doublereal *rcond;
integer *sing, *dd, *tdeg, *cdeg, *lq;
doublereal *lf;
logical *setlf;
doublereal *s;
{
    ...
    extern /* Subroutine */ int ehg127_(), ehg182_(), ehg137_();
    extern doublereal ehg128_();
...
/* Subroutine */ int lowesb_(xx, yy, ww, diagl, infl, iv, liv, lv, wv)
doublereal *xx, *yy, *ww, *diagl;
logical *infl;
integer *iv, *liv, *lv;
doublereal *wv;
{
    ...
    /* Local variables */
    extern /* Subroutine */ int ehg131_(), ehg182_(), ehg183_();
...
/* Subroutine */ int lowesd_(versio, iv, liv, lv, v, d__, n, f, ideg, nvmax, 
	setlf)
integer *versio, *iv, *liv, *lv;
doublereal *v;
integer *d__, *n;
doublereal *f;
integer *ideg, *nvmax;
...
/* Subroutine */ int lowese_(iv, liv, lv, wv, m, z__, s)
integer *iv, *liv, *lv;
doublereal *wv;
integer *m;
doublereal *z__, *s;
{
    ...
    /* Local variables */
    extern /* Subroutine */ int ehg133_(), ehg182_();
...
/* Subroutine */ int lowesf_(xx, yy, ww, iv, liv, lv, wv, m, z__, l, ihat, s)
doublereal *xx, *yy, *ww;
integer *iv, *liv, *lv;
doublereal *wv;
integer *m;
...
doublereal *s;
{
    ...
    /* Local variables */
    extern /* Subroutine */ int ehg136_(), ehg182_();
    static logical i1;
...
/* Subroutine */ int lowesl_(iv, liv, lv, wv, m, z__, l)
integer *iv, *liv, *lv;
doublereal *wv;
integer *m;
doublereal *z__, *l;
{
    ...
    /* Local variables */
    extern /* Subroutine */ int ehg182_(), ehg191_();
...
/* Subroutine */ int lowesr_(yy, iv, liv, lv, wv)
doublereal *yy;
integer *iv, *liv, *lv;
doublereal *wv;
{
    ...
    extern /* Subroutine */ int ehg182_(), ehg192_();
...
/* Subroutine */ int lowesw_(res, n, rw, pi)
doublereal *res;
integer *n;
doublereal *rw;
integer *pi;
...
/* Subroutine */ int lowesp_(n, y, yhat, pwgts, rwgts, pi, ytilde)
integer *n;
doublereal *y, *yhat, *pwgts, *rwgts;
integer *pi;
doublereal *ytilde;
{
    /* Initialized data */
...
/* Subroutine */ int ehg124_(ll, uu, d__, n, nv, nc, ncmax, vc, x, pi, a, xi, 
	lo, hi, c__, v, vhit, nvmax, fc, fd, dd)
integer *ll, *uu, *d__, *n, *nv, *nc, *ncmax, *vc;
doublereal *x;
integer *pi, *a;
doublereal *xi;
integer *lo, *hi, *c__;
doublereal *v;
integer *vhit, *nvmax, *fc;
doublereal *fd;
integer *dd;
{
    /* Initialized data */
    ...
    extern /* Subroutine */ int ehg125_(), ehg106_(), ehg129_();
...
/* Subroutine */ int ehg129_(l, u, d__, x, pi, n, sigma)
integer *l, *u, *d__;
doublereal *x;
integer *pi, *n;
doublereal *sigma;
...
/* Subroutine */ int ehg137_(z__, kappa, leaf, nleaf, d__, nv, nvmax, ncmax, 
	vc, a, xi, lo, hi, c__, v)
doublereal *z__;
integer *kappa, *leaf, *nleaf, *d__, *nv, *nvmax, *ncmax, *vc, *a;
doublereal *xi;
integer *lo, *hi, *c__;
doublereal *v;
{
